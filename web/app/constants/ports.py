KNOWN_PORTS = {
    ...
    # 💻 개발 도구 및 미들웨어 (내부망 전용 권장)
    2375: "Docker-API (도커 원격 제어)",
    ...
    # 🛠️ 보안 위협 및 침투 테스트 도구 (탐지 시 즉시 조치 필요)
