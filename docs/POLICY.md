...
- [[1] 프로세스 분석 정책](#1-프로세스-분석-정책)
- [[2] 프로세스 종료 정책](#2-프로세스-종료-정책)
- [[3] MongoDB 기반 종료 정책 보조 레이어](#3-mongodb-기반-종료-정책-보조-레이어)
- [이 문서의 범위](#이-문서의-범위)
...
- 이 항목은 외부 공개 여부를 직접 의미하지 않음
- 포트 사용 사실 자체를 Warning으로 기록
...
- 운영 서버 환경에서의 프로세스 보안 분석 기준
- 위험 판단 규칙(Warning Rules) 및 우선순위
- 프로세스 종료 정책 및 보호 규칙 정의
